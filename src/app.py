...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice team drills and play competitive soccer matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "jordan@mergington.edu"]
    },
    "Yoga Club": {
        "description": "Stretch, relax, and build strength with guided yoga sessions",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["sophia@mergington.edu", "owen@mergington.edu"]
    }
}
